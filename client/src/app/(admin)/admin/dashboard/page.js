...
export default function AdminDashboardPage() {
  const totalRevenue = adminOrdersWithTotals.reduce(
  ...
  return (
    <>
      ...
      <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <AdminStatCard
          label="Orders"
          value={String(adminOrdersWithTotals.length)}
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <span className="font-bold text-slate-900">
                {
                  products
                    ...
                    .filter((variant) => variant.stock < 10).length
                }
              </span>
            </div>
          </div>
          ...
          <div className="mt-5 grid gap-2">
            ...
            <Link
              ...
              className="rounded-xl bg-slate-100 px-3 py-2 text-center text-sm font-semibold text-slate-700 hover:bg-slate-200"
            >
              Manage Categories
            </Link>
            <Link
