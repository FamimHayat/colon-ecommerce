...
export default function ContactPage() {
  return (
    <section className="min-h-screen px-4 sm:px-6 lg:px-8 py-16 sm:py-24 flex items-center justify-center bg-background">
      <div className="w-full max-w-5xl space-y-10 sm:space-y-14 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 lg:gap-8">
          {/* PHONE */}
          <div className="border border-border rounded-2xl p-5 sm:p-6 space-y-4 hover:shadow-sm transition">
          ...
          {/* MESSENGER */}
          <div className="border border-border rounded-2xl p-5 sm:p-6 space-y-4 hover:shadow-sm transition sm:col-span-2 lg:col-span-1">
