...
export default function AcceptCookies() {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 bg-foreground text-background border border-background/20 rounded button-shadow p-4 md:p-6 w-[95%] max-w-md flex flex-col md:flex-row items-center justify-between gap-4 z-1150">
