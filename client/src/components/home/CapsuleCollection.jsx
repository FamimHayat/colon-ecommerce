...
const CapsuleCollection = () => {
  return (
    <section className="container mx-auto py-15  px-3 overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div>
          <h2
            ...
            className=" text-[calc(10px+5vw)] sm:text-[calc(10px+5vw)] lg:text-[calc(10px+3vw)] font-bebas text-shadow-lighter text-brand  mb-4"
          >
          ...
          >
            Curated Fashion Just For You. Save Up To 10% Today
          </p>
